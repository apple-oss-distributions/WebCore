...
struct DocumentMarker {
    enum MarkerType {
        ...
        DictationPhraseWithAlternatives = 1 << 9,
        DictationResult = 1 << 10,
    };
    ...
    public:
        AllMarkers()
            : MarkerTypes(Spelling | Grammar | TextMatch | Replacement | CorrectionIndicator | RejectedCorrection | Autocorrected | SpellCheckingExemption | DeletedAutocorrection | DictationPhraseWithAlternatives | DictationResult)
        {
        }
    };
