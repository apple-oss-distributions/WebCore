...
private:
    ...
    void setDataAndUpdate(PassRefPtr<StringImpl>, unsigned offsetOfReplacedData, unsigned oldLength, unsigned newLength, LastCharacterBehavior = DefaultLastCharacterBehavior);
