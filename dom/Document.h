...
public:
     ...
     * constructed from these which is used to create the a new style resolver which collates all of the stylesheets
...
protected:
#if PLATFORM(IOS)
    Document(Frame*, const KURL&, unsigned = DefaultDocumentClass, bool isSynthesized = false);
#else
