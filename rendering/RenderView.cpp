...
static inline IntSize fixedPositionOffset(const FrameView* frameView)
{
    return frameView->useCustomFixedPositionLayoutRect() ? (frameView->customFixedPositionLayoutRect().location() - IntPoint()) : frameView->scrollOffset();
}
