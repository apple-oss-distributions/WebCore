...
// FIXME: These should NOT be PLATFORM(IPHONE), they should really migrate back to TOT
// FIXME: MIGRATE
    ...
    virtual bool paintButtonDecorations(RenderObject*, const RenderObject::PaintInfo&, const IntRect& r) { return true; }
