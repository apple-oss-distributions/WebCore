...
public:
    ...
    void setMarginStartForChild(RenderBox* child, LayoutUnit) const;
    void setMarginEndForChild(RenderBox* child, LayoutUnit) const;
    void setMarginBeforeForChild(RenderBox* child, LayoutUnit) const;
    void setMarginAfterForChild(RenderBox* child, LayoutUnit) const;
