...
namespace WebCore {
    ...
    // This is necessary to ensure we destroy the ScheduledAction when Timeouts are put into a HashMap.
    // Previously, deleting a HashMap of PausedTimeouts would not destroy the ScheduledAction.  <rdar://problem/5960962>
    struct DeferredTimeout : PausedTimeout
    {
        ~DeferredTimeout();
    };
