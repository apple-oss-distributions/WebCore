...
class StyledElement;
    ...
    public:
        ...
        void addKeyframeStyle(Document* doc, WebKitCSSKeyframesRule* rule);
        void arenaDestroy();

        static void createTimingFunction(CSSValue* inValue, TimingFunction& outTimingFunction);
    ...
    private:
        ...
        void mapAnimationDirection(Transition*, CSSValue*);

        void mapTransitionDuration(Transition*, CSSValue*);
        void mapAnimationName(Transition*, CSSValue*);
        void mapAnimationPlayState(Transition*, CSSValue*);
        void mapTransitionIterationCount(Transition*, CSSValue*);
        void mapAnimationDelay(Transition*, CSSValue*);
