...
PassRefPtr<CSSValue> ComputedStyleExtractor::propertyValue(CSSPropertyID propertyID, EUpdateLayout updateLayout) const
{
    ...
    switch (propertyID) {
        ...
        case CSSPropertyWebkitTouchCallout: {
            return style->touchCalloutEnabled() ? CSSPrimitiveValue::createIdentifier(CSSValueDefault) : cssValuePool().createIdentifierValue(CSSValueNone);
        }
