...
{
    // FIXME: We force it to be a 'user-driven' change, as it was before the 4.0 merge.
    // This should be removed once <rdar://problem/5808484> is fixed.
    SelectElement::setSelectedIndex(m_data, this, optionIndex, deselect, false, true);
}
