...
PassOwnPtr<InputType> InputType::create(HTMLInputElement* element, const String& typeName)
{
    ...
    if (factory == NumberInputType::create && element->document()->settings() && element->document()->settings()->useLegacyNumberInputFieldFormatting())
        factory = LegacyNumberInputType::create;
