...
public:
    ...
    virtual bool disabled() const { return isFileUpload() || HTMLFormControlElement::disabled(); }
    virtual void setDisabled(bool isDisabled) { HTMLFormControlElement::setDisabled(isFileUpload() || isDisabled); }
